...
static _Py_AuditHookEntry *auditHookHead = NULL;
...
PySys_Audit(const char *event, const char *argFormat, ...)
{
    ...
    for (_Py_AuditHookEntry *e = auditHookHead; e; e = e->next) {
...
void _PySys_ClearAuditHooks(void) {
    ...
    _Py_AuditHookEntry *e = auditHookHead, *n;
    auditHookHead = NULL;
    while (e) {
        n = e->next;
        if (!e->hookCFunction)
...
addaudithook_helper(_Py_AuditHookFunction hookCFunction, PyObject *hookCallable, void *userData)
{
    ...
    _Py_AuditHookEntry *e = auditHookHead;
    if (!e) {
        auditHookHead = e = (_Py_AuditHookEntry*)malloc(sizeof(_Py_AuditHookEntry));
    } else {
        while (e->next)
            e = e->next;
